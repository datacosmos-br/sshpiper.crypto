...
func SupportedAlgorithms() Algorithms {
	...
	kexAlgos := slices.Clone(supportedKexAlgos)
	if fips140.Enabled() {
		ciphers = slices.DeleteFunc(ciphers, func(name string) bool { return cipherModes[name] == nil })
		macs = slices.DeleteFunc(macs, func(name string) bool { return macModes[name] == nil })
		kexAlgos = slices.DeleteFunc(kexAlgos, func(name string) bool { return kexAlgoMap[name] == nil })
	}
	return Algorithms{
		Ciphers:        ciphers,
		MACs:           macs,
